                                                ...
                                                <div class="col-lg-6 col-12 mt-3 mt-lg-0 mb-lg-0 mb-3">
                                                      <div class="product-info d-flex align-items-center">
                                                            ...
                                                            <div class="product-details">
                                                                  <h6 class="product-title">Lorem ipsum dolor sit
                                                                        amet</h6>
                                          ...
                                          <div class="row align-items-center">
                                                <div class="col-lg-6 col-12 mt-3 mt-lg-0 mb-lg-0 mb-3">
                                                      <div class="product-info d-flex align-items-center">
                                                            ...
                                                            <div class="product-details">
                                                                  <h6 class="product-title">Consectetur adipiscing
                                                                        elit</h6>
                                                                  <div class="product-meta">
                                                                        <span class="product-color">Color:
                                                                              White</span>
                                                ...
                                                <div class="col-lg-2 col-12 mt-3 mt-lg-0 text-center">
                                                      <div class="quantity-selector">
                                                            ...
                                                            <input type="number" class="quantity-input" value="2"
                                                                  min="1" max="10">
                                                            <button class="quantity-btn increase">
                                                                  <i class="bi bi-plus"></i>
                                                            </button>
                                          ...
                                          <div class="row align-items-center">
                                                <div class="col-lg-6 col-12 mt-3 mt-lg-0 mb-lg-0 mb-3">
                                                      <div class="product-info d-flex align-items-center">
                                                            ...
                                                            <div class="product-details">
                                                                  <h6 class="product-title">Sed do eiusmod tempor
                                                                  </h6>
                                                                  <div class="product-meta">
                                                                        <span class="product-color">Color:
                                                                              Blue</span>
